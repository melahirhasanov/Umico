    ...
    const Home=()=>{
        ...
        return(
            ...
            <div className={style.CatalogDiv}><img className={style.CatalogImg} src="https://strgimgr.umico.az/dcmimages/4596/280x138ru1_41130.jpg"/>
                 ...
                 <div className={style.CatalogCart}><div className={style.CatalogCartDiv}><i className="fa-solid fa-bag-shopping" id={style.BagId}></i><p className={style.BagP}>500 000-dən çox məhsul</p></div><hr/> <div className={style.CatalogCartDiv}><i className="fa-solid fa-truck" id={style.TruckId}></i><p className={style.TruckP}>50 ₼-dən başlayan sifarişlərə pulsuz çatdırılma</p> </div><hr/><div className={style.CatalogCartDiv}><i className="fa-regular fa-percent" id={style.PercentId}></i><p className={style.PercentP}>Endirimlər və aksiyalar</p> </div><hr/><div className={style.CatalogCartDiv}><i className="fa-regular fa-credit-card" id={style.CartId}></i><p className={style.CartP}>Birbank ilə 24 ayadək taksit</p> </div></div>
...
<div className={style.AgeSeenCartss}>           
  ...
  breakpoints={{1000:{slidesPerView:3},345:{slidesPerView:2}}}
>
  <SwiperSlide>
  ...
  <Swiper
    className={style.BrandSwiper}  breakpoints={{1300:{slidesPerView:5},345:{slidesPerView:2},540:{slidesPerView:3,330:{slidesPerView:1,spaceBetween:400}}}}
...
<div className={style.Brendss}> 
            ...
            <div className={style.PopulyarBrends}>
  <Swiper
  breakpoints={{1300:{slidesPerView:5},345:{slidesPerView:2},540:{slidesPerView:3},330:{slidesPerView:1,spaceBetween:400}}}
...
<div className={style.EndCost}> <h1 className={style.EcHeader}>Bu gün aktual olanlar</h1><div> <h1 className={style.uHed1}><img className={style.HedLogo} src="data:image/png;base64," alt="" /> Umico<span className={style.Market}>Market</span></h1>
  ...
       </div>
  <div className={style.ActualCarts}> <div className={style.Stehero}><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/d5/1b/0d/d51b0d8826063f245dc38e9ff6c5c263.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/38/95/52/389552d7b70c1cb3e5355392fbad23c0.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div></div><div className={style.Stehero}><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/75/14/12/7514125fdc5e9b99d3deed49cf00153c.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/b6/c8/d6/b6c8d61a1dae85c8a2b564af4cf05e3a.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/38/a9/9e/38a99ef27007cfae409d65c0b935c9d8.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div></div>
   <div className={style.ActualCarts}> <div className={style.Stehero}><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/b3/ca/75/b3ca7546de22e55fd0c658ea1cb9bf92.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/14/11/82/14118287d2e7c3d7940a12721da1171b.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/73/ed/49/73ed49b900a5a103df74599ad44e490a.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div><div className={style.ActualCart}><img className={style.PhotoActual} src="https://i.pinimg.com/736x/56/71/32/567132eacdcce7c19ae8646fbe142ff9.jpg" alt="" /><p className={style.ActualTitle}>Telefonlar,Smart Cihazlar<br/> və Telefon Aksesuarları</p></div></div>
...
<div className={style.AgeSeenCartss}>           
  ...
  scrollbar={{draggable:true}} 
  modules={[Navigation,Pagination,Autoplay]}
    breakpoints={{1300:{slidesPerView:4},345:{slidesPerView:2},540:{slidesPerView:3},330:{slidesPerView:1}}}
